...
class VinylSwitch:
    ...
    def switch(self, e=0):
        ...
        if self.state:
            ...
            for i in range(30):
                angle = pi/7/30*i
                self.canvas.after(int(i/100*500), lambda a=angle: self.canvas.coords(self.arm[0], 230, 210, 230-sin(a)*170, 40+170-cos(a)*170))
                self.canvas.after(int(i/100*500), lambda a=angle: self.canvas.coords(self.arm[1], *get_rot(217, 28, 230, 210, a),
